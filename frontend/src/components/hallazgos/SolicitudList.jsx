  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        <h3 style={{ margin: 0, color: '#1e40af' }}>Solicitudes de Cambio de Responsable</h3>
        {pendientes > 0 && (
          <span style={{
            background: '#f59e0b',
            color: '#fff',
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 12 }}>
                <div style={{ flex: 1 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: '0.5rem' }}>
                    <span style={{ fontSize: '0.85rem', fontWeight: 600, color: '#6b7280' }}>#{solicitud.id}</span>
                    <div
                      style={{
                  ...
                  <div style={{ display: 'grid', gap: 6 }}>
                    <div>
                      ...
                      <span style={{ color: '#1f2937' }}>{solicitud.solicitante_nombre}</span>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      <span style={{ fontWeight: 600, color: '#374151' }}>
                        {solicitud.tipo === 'agregar' ? '➕' : '🔄'} {solicitud.tipo === 'agregar' ? 'Agregar a:' : 'Reemplazar por:'}
                      </span>
                      <span style={{ color: '#1f2937', fontWeight: 600 }}>{solicitud.usuario_propuesto_nombre}</span>
                    </div>
                  </div>
                </div>
              </div>
