...
Creates: CustomUser, EmpleadoProfile, ClienteProfile
Hand-written to match apps/users/models.py — run `python manage.py migrate` to apply.

Note: first_name and last_name are intentionally absent (set to None in CustomUser).
"""
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sector",
                    models.CharField(max_length=100, verbose_name="Sector"),
                ),
                (
                    "user",
